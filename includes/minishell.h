...
/*   Updated: 2022/08/06 22:56:17 by pcamaren         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		get_redirs(t_elem *redirections, int *rw_fds);
...
int			ft_export_list(t_shell *shell, t_pipeline *data, int *rw_fds);
...
void		free_exit(int exit, t_shell *shell, t_pipeline *cmds, int opt);
